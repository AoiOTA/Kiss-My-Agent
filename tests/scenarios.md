...
20. **v0.1 compatibility.** Copy `tests/fixtures/v0.1-managed-project` to a disposable project. Expect v0.2 check to recognize it and remove to recognize byte-identical v0.1 seeds.
