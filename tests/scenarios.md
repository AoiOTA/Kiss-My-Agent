...
These scenarios support human discussion of the guidance. They are not scores, automated evaluations, release gates, or claims that an agent will behave identically in every environment.
